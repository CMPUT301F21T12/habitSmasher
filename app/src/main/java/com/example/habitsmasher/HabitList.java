...
public class HabitList extends ArrayList<Habit>{
     ...
     */
    public void addHabitToDatabase(String title, String reason, Date date, DaysTracker tracker, boolean isPublic, String userId) {
     ...
     */
    public void editHabitInDatabase(String newTitle, String newReason, Date newDate, DaysTracker tracker, boolean isPublic, int pos, String userId) {
